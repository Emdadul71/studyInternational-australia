...
const LeadFormService = ({ isSmall }: propTypes) => {
          ...
          <Form>
            <div
              className={` grid grid-cols-1 gap-3 ${
                isSmall ? "grid-cols-1 gap-3" : "lg:grid-cols-2 gap-[15px]"
              } `}
            >
              <div>
                ...
                <Field
                  type="text"
                  name="firstName"
                  className={`block w-full py-2 focus:border-white text-white px-4 outline-none placeholder:text-[14px] placeholder:text-[#8e8e93] border-[#8e8e93] bg-transparent border-b `}
              ...
              <div className={`prefarance_phone_input`}>
                ...
                <PhoneInput
                  ...
                  className={`block w-full focus:border-white  px-4 pb-[5px] placeholder:text-[#8e8e93] placeholder:text-[14px]   border-[#8e8e93]  bg-transparent border-b `}
                  value={values?.mobile ?? ""}
                  ...
                  value={
                    values.preferredCountry
                      ? PreferredCountry.filter(
                          (item: any) => item.value == values.preferredCountry
                        )
                      : ""
                  }
                  ...
                  value={
                    values.preferredIntake
                      ? preferredIntake.filter(
                          (item: any) => item.value == values.preferredIntake
                        )
                      : ""
                  }
              ...
              <div>
                ...
                <Select
                  ...
                  value={
                    values.funding
                      ? funding.filter(
                          (item: any) => item.value == values.funding
                        )
                      : ""
                  }
                  options={funding}
